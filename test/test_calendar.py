...
class TestDailyCalendar:
    def test_daily_calendar_no_trips(self, sample_person: Person):
    ...
    def test_daily_calendar_trip_in_calendar(self, sample_home_location: Location, sample_person: Person):
